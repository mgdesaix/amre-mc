...
#SBATCH --output=./err-out/merged-AMRE.%A_%a.out
#SBATCH --error=./err-out/merged-AMRE.%A_%a.err
################
...
sample_id=$(awk -v N=$SLURM_ARRAY_TASK_ID 'NR == N {print $1}' amre-sample-list)
